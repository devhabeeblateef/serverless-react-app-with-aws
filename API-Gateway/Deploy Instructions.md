...
Configure CORS. All 6 fields should be configured:
    The bucket URL (for N.Virgina buckets) should be: https://item-frontend-static-hosting-2ssl.s3.amazonaws.com
...
* Invoke URL: https://1dc54ln273.execute-api.us-east-1.amazonaws.com/prod
